                    ...
                    <form className="signup-form">
                        <div className="form-row">
                            <div className="form-group">
                                ...
                                <input id='fullName' onChange={(e) => setDisplayName(e.target.value)} value={displayname} className='input-format' type="text" placeholder="ناوی سیانیت بنوسە" required />
                            </div>
                            <div className="form-group">
                        ...
                        <div className="form-row">
                            <div className="form-group">
                                ...
                                <input readOnly onChange={handleChange} id='gmail' value={formData.gmail} className='input-format' type="email" placeholder="ئیمەیڵەکەت بنوسە" required />
                            </div>
